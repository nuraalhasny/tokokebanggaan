          ...
          <li class="nav-item">
            ...
            <div class="collapse" id="uiComponents">
              <ul class="nav sub-menu">
                ...
                <li class="nav-item">
                  <a href="brand.php" class="nav-link">Product color</a>
                </li>
                <li class="nav-item">
...
while ($item = $result->fetch_assoc()){
  ...
  $result_sizes = $conn_size->query("SELECT id, (
    SELECT nama FROM sizes WHERE size_id = sizes.id
  ) AS size_name FROM size_has_product_color WHERE product_has_color_id = '".$item['id']."'
  ");
?>
											<tr>
